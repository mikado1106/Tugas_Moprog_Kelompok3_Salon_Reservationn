//seperti nya ini bakal jadi bodyspa baru
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('img/spa0.jpg'), // Ganti dengan gambar yang sesuai
                          fit: BoxFit.cover,
                        ),
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Body Spa added to cart for ${selectedTime.format(context)} on ${DateFormat('dd/MM/yyyy').format(selectedDate)}')),
                      );
                    },
