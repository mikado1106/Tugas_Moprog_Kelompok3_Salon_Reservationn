//seperti nya ini bakal jadi MakeupPage baru
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('img/makeup0.jpg'), // Ganti dengan gambar yang sesuai
                          fit: BoxFit.cover,
                        ),
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Make Up added to cart for ${selectedTime.format(context)} on ${DateFormat('dd/MM/yyyy').format(selectedDate)}')),
                      );
                    },
