//seperti nya ini bakal jadi Hair Cut baru
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('img/haircut0.jpg'), // Ganti dengan gambar yang sesuai
                          fit: BoxFit.cover,
                        ),
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Hair Cut added to cart for ${selectedTime.format(context)} on ${DateFormat('dd/MM/yyyy').format(selectedDate)}')),
                      );
                    },
